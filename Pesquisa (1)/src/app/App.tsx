...
const Screen1 = memo(({ onNext, onDashboard }: { onNext: () => void; onDashboard: () => void }) => (
  <div className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-8 py-8 sm:py-16 bg-white">
    ...
    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full max-w-xl px-4">
      ...
      >
        <BarChart3 size={20} className="sm:w-6 sm:h-6" style={{ color: '#B8963A' }} />
        Ver Dashboard
      </button>
    </div>
  </div>
...
// Screen 2 Component
const Screen2 = memo(({ answers, updateAnswer, onNext, onBack }: { 
  answers: Answers; 
...
// Screen 3 Component  
const Screen3 = memo(({ answers, updateAnswer, onNext, onBack }: { 
  answers: Answers; 
  updateAnswer: (key: keyof Answers, value: string) => void;
  onNext: () => void;
  onBack: () => void;
...
// Screen 4 Component - Desafios digitais
const Screen4 = memo(({ answers, updateAnswer, onNext, onBack }: { 
  answers: Answers; 
  updateAnswer: (key: keyof Answers, value: string) => void;
  onNext: () => void;
  onBack: () => void;
...
// Screen 5 Component - Música
const Screen5 = memo(({ answers, updateAnswer, onNext, onBack }: { 
  answers: Answers; 
  updateAnswer: (key: keyof Answers, value: string) => void;
  onNext: () => void;
  onBack: () => void;
...
// Screen 6 Component - Vídeos
const Screen6 = memo(({ answers, updateAnswer, onNext, onBack }: { 
  answers: Answers; 
  updateAnswer: (key: keyof Answers, value: string) => void;
  onNext: () => void;
  onBack: () => void;
  ...
  <div className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-8 py-8 sm:py-16 bg-gray-50">
    ...
    <div className="rounded-lg mb-6 sm:mb-10 w-full max-w-sm sm:max-w-md overflow-hidden shadow-lg mx-auto" style={{ aspectRatio: '9/16', maxHeight: '500px' }}>
      <iframe
        width="100%"
        height="100%"
...
// Screen 7 Component - Cursos
const Screen7 = memo(({ answers, updateAnswer, onNext, onBack }: { 
  answers: Answers; 
  updateAnswer: (key: keyof Answers, value: string) => void;
  onNext: () => void;
  onBack: () => void;
...
// Screen 8 Component - Avaliação
const Screen8 = memo(({ answers, updateAnswer, onNext, onBack }: { 
  answers: Answers; 
  updateAnswer: (key: keyof Answers, value: string) => void;
  onNext: () => void;
  onBack: () => void;
...
// Screen 9 Component - Observações
const Screen9 = memo(({ answers, updateAnswer, onNext, onBack }: { 
  answers: Answers; 
  updateAnswer: (key: keyof Answers, value: string) => void;
  onNext: () => void;
  onBack: () => void;
...
// Screen 10 Component - Revisão
const Screen10 = memo(({ answers, onEdit, onConfirm }: { 
  answers: Answers;
...
// Screen 11 Component - Finalização
const Screen11 = memo(({ onDashboard, onNewSurvey }: { 
  onDashboard: () => void;
  onNewSurvey: () => void;
}) => (
  <div className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-8 py-8 sm:py-16 bg-white">
